      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center mb-10 sm:mb-16">
          <div className="animate-slide-up">
            <div className="text-3xl sm:text-6xl lg:text-8xl font-black text-[hsl(25,95%,53%)] mb-2 sm:mb-4">50+</div>
            <h2 className="text-xl sm:text-4xl lg:text-5xl font-bold text-[hsl(25,95%,53%)] mb-2 sm:mb-4">
              Collaborating with the best
              <span className="block">to shape your future</span>
            </h2>
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4 sm:gap-6 mb-8 sm:mb-12 w-full">
          {universities.map((university, index) => (
            ...
            >
              <div className="h-10 sm:h-20 bg-gradient-to-br from-orange-50 to-orange-100 rounded-lg flex items-center justify-center group-hover:from-[hsl(25,95%,53%)] group-hover:to-[hsl(35,95%,60%)] transition-all duration-300">
