...
export default function AIBluSection() {
  ...
  return (
    <section className="py-10 sm:py-16 md:py-20 bg-gradient-to-br from-gray-900 to-blue-900 text-white relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center mb-10 sm:mb-16">
          <div className="animate-slide-up">
            <span className="text-[hsl(217,91%,60%)] font-medium text-base sm:text-lg mb-4 block tracking-wider">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 w-full">
          {/* Top Row */}
          <div className="bg-gray-800/50 border border-blue-500/30 rounded-2xl p-6 sm:p-8 hover:bg-gray-800/70 transition-all duration-300 animate-scale-in">
            ...
            <Button variant="ghost" className="w-full sm:w-auto text-[hsl(217,91%,60%)] font-semibold hover:underline p-0 mt-4">
              Learn More →
            </Button>
          </div>
          <div className="bg-gray-800/50 border border-blue-500/30 rounded-2xl p-6 sm:p-8 hover:bg-gray-800/70 transition-all duration-300 animate-scale-in" style={{ animationDelay: '0.2s' }}>
