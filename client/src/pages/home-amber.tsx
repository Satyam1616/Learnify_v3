...
function AmberHero() {
  return (
    <section className="pt-16 pb-20 sm:pt-20 sm:pb-32 bg-gradient-to-br from-amber-50 via-white to-yellow-50 min-h-[90vh] lg:min-h-[100vh] flex flex-col justify-center overflow-hidden">
      <div className="w-full px-4 md:max-w-7xl md:mx-auto md:px-6 lg:px-8">
        <div className="flex flex-col lg:grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          <div className="space-y-8 w-full">
            <div className="inline-flex items-center bg-amber-100 text-amber-700 px-4 py-2 rounded-full text-xs sm:text-sm font-medium animate-fade-in">
            ...
            <div className="space-y-6">
              <div className="space-y-2">
                ...
                <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-black leading-tight bg-gradient-to-r from-amber-600 to-yellow-600 bg-clip-text text-transparent animate-text-reveal" style={{ animationDelay: '0.2s' }}>
                  Career Starts Here
                </h1>
              </div>
            ...
            <Button className="w-full sm:w-auto bg-amber-600 hover:bg-amber-700 text-white px-8 py-4 rounded-xl font-semibold text-base sm:text-lg hover-lift animate-scale-in" style={{ animationDelay: '0.8s' }}>
              Start Your Journey
            </Button>
          </div>
          ...
          <div className="relative w-full mt-8 lg:mt-0">
            ...
            <div className="grid grid-cols-2 gap-2 sm:gap-4 lg:gap-4 max-w-sm sm:max-w-lg lg:max-w-2xl mx-auto">
              ...
              <div className="bg-gradient-to-br from-orange-300 to-orange-400 rounded-lg sm:rounded-xl lg:rounded-2xl p-3 sm:p-5 lg:p-6 relative overflow-hidden animate-slide-up min-h-[160px] sm:min-h-[200px] lg:min-h-[220px]" style={{ animationDelay: '0.6s' }}>
                <div className="relative z-10">
              ...
              <div className="bg-gradient-to-br from-amber-300 to-amber-400 rounded-lg sm:rounded-xl lg:rounded-2xl p-3 sm:p-5 lg:p-6 relative overflow-hidden animate-slide-up min-h-[160px] sm:min-h-[200px] lg:min-h-[220px]" style={{ animationDelay: '0.8s' }}>
                <div className="relative z-10">
              ...
              <div className="bg-gradient-to-br from-yellow-300 to-yellow-400 rounded-lg sm:rounded-xl lg:rounded-2xl p-3 sm:p-5 lg:p-6 relative overflow-hidden animate-slide-up min-h-[160px] sm:min-h-[200px] lg:min-h-[220px]" style={{ animationDelay: '1s' }}>
                <div className="relative z-10">
...
export default function HomeAmber() {
  return (
    <ThemedLayout theme="amber">
      <AmberHero />
      <ThemedStatsSection theme="amber" />
      <ThemedMentorshipSection theme="amber" />
      <ThemedCourseCardsSection theme="amber" />
      <ThemedPartnersSection theme="amber" />
      <ThemedLearningModules theme="amber" />
      <ThemedStudyAbroadSection theme="amber" />
      <ThemedTestimonialsSection theme="amber" />
      <ThemedContactFormSection theme="amber" />
      <HomePageSwitcher />
    </ThemedLayout>
  );
}