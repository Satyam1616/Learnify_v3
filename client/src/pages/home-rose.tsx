...
import ThemedStatsSection from "@/components/ThemedStatsSection";
import ThemedMentorshipSection from "@/components/ThemedMentorshipSection";
import ThemedCourseCardsSection from "@/components/ThemedCourseCardsSection";
import ThemedPartnersSection from "@/components/ThemedPartnersSection";
import ThemedLearningModules from "@/components/ThemedLearningModules";
import ThemedStudyAbroadSection from "@/components/ThemedStudyAbroadSection";
import ThemedTestimonialsSection from "@/components/ThemedTestimonialsSection";
import { ThemedContactFormSection } from "@/components/ThemedMediaSection";

function RoseHero() {
  return (
    <section className="pt-16 pb-20 sm:pt-20 sm:pb-32 bg-gradient-to-br from-rose-50 via-white to-pink-50 min-h-[90vh] lg:min-h-[100vh] flex flex-col justify-center overflow-hidden">
      <div className="w-full px-4 md:max-w-7xl md:mx-auto md:px-6 lg:px-8">
        <div className="flex flex-col lg:grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          <div className="space-y-8 w-full">
            <div className="inline-flex items-center bg-rose-100 text-rose-700 px-4 py-2 rounded-full text-xs sm:text-sm font-medium animate-fade-in">
            ...
            <div className="space-y-6">
              <div className="space-y-2">
                ...
                <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-black leading-tight bg-gradient-to-r from-rose-600 to-pink-600 bg-clip-text text-transparent animate-text-reveal" style={{ animationDelay: '0.2s' }}>
                  Career Starts Here
                </h1>
              </div>
            ...
            <Button className="w-full sm:w-auto bg-rose-600 hover:bg-rose-700 text-white px-8 py-4 rounded-xl font-semibold text-base sm:text-lg hover-lift animate-scale-in" style={{ animationDelay: '0.8s' }}>
              Start Your Journey
            </Button>
          </div>
          ...
          <div className="relative w-full mt-8 lg:mt-0">
            ...
            <div className="absolute -top-4 sm:-top-6 lg:-top-8 left-1/2 transform -translate-x-1/2 flex space-x-2">
              <div className="w-1.5 h-1.5 sm:w-2 sm:h-2 bg-rose-600 rounded-full"></div>
              <div className="w-1.5 h-1.5 sm:w-2 sm:h-2 bg-rose-600 rounded-full"></div>
              <div className="w-1.5 h-1.5 sm:w-2 sm:h-2 bg-rose-600 rounded-full"></div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-2 sm:gap-4 lg:gap-4 max-w-sm sm:max-w-lg lg:max-w-2xl mx-auto">
              {/* Study Abroad Card */}
              <div className="bg-gradient-to-br from-emerald-300 to-emerald-400 rounded-lg sm:rounded-xl lg:rounded-2xl p-3 sm:p-5 lg:p-6 relative overflow-hidden animate-slide-up min-h-[160px] sm:min-h-[200px] lg:min-h-[220px]" style={{ animationDelay: '0.4s' }}>
              ...
              <div className="bg-gradient-to-br from-pink-300 to-pink-400 rounded-lg sm:rounded-xl lg:rounded-2xl p-3 sm:p-5 lg:p-6 relative overflow-hidden animate-slide-up min-h-[160px] sm:min-h-[200px] lg:min-h-[220px]" style={{ animationDelay: '0.6s' }}>
                <div className="relative z-10">
              ...
              <div className="bg-gradient-to-br from-rose-300 to-rose-400 rounded-lg sm:rounded-xl lg:rounded-2xl p-3 sm:p-5 lg:p-6 relative overflow-hidden animate-slide-up min-h-[160px] sm:min-h-[200px] lg:min-h-[220px]" style={{ animationDelay: '0.8s' }}>
                <div className="relative z-10">
              ...
              <div className="bg-gradient-to-br from-fuchsia-300 to-fuchsia-400 rounded-lg sm:rounded-xl lg:rounded-2xl p-3 sm:p-5 lg:p-6 relative overflow-hidden animate-slide-up min-h-[160px] sm:min-h-[200px] lg:min-h-[220px]" style={{ animationDelay: '1s' }}>
                <div className="relative z-10">
...
export default function HomeRose() {
  return (
    <ThemedLayout theme="rose">
      <RoseHero />
      <ThemedStatsSection theme="rose" />
      <ThemedMentorshipSection theme="rose" />
      <ThemedCourseCardsSection theme="rose" />
      <ThemedPartnersSection theme="rose" />
      <ThemedLearningModules theme="rose" />
      <ThemedStudyAbroadSection theme="rose" />
      <ThemedTestimonialsSection theme="rose" />
      <ThemedContactFormSection theme="rose" />
      <HomePageSwitcher />
    </ThemedLayout>
  );
}